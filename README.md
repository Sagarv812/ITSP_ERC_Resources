...
This repository brings together a curated set of tools, guides, and references to help teams working on Institute Technical Summer Projects (ITSP). Whether you're building circuits, writing embedded code, setting up simulations, or experimenting with control systems, these resources are meant to give you a solid starting point and help streamline your development process. The goal is to support thoughtful, well-structured project work—while letting you focus more on solving problems than searching for the right tools.


> ### The content from the ITSP Bootcamp conducted by ERC on 2nd June is available [here](./Webinar%20Resources/README.md)  

---

# Resources for Simulation

Here you'll find essential tools and references to support your project development—from simulation and coding to design and testing. These resources are key to building, experimenting, and bringing your ideas to life effectively.
